...
const RegisterComponent = ({
	...
	const handleOtpSend = () => {
		...
		btn.disabled = true;
		sentVerificationCode(voter.email)
			.then((r) => {
				setOtpSent(true);
			})
			.catch((err) => {
			...
			<div className="modal-dialog">
				<div className="modal-content w-100 card">
					...
					<div className="row w-100 g-1">
						...
						<div
							className={
								verificationStatus ? 'col-12' : 'col-9'
							}>
							<div className="input-group has-validation">
								<div
									className={`form-floating mb-1 rounded-2 ${
						...
						<div className="col-12">
							<button
								className="btn btn-primary w-100 mt-1 mb-1"
								disabled={
									!verificationStatus || !validEmail
								}

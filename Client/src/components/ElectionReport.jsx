		...
		<div className="election-report">
			...
			<table className="table table-bordered mt-3">
				<thead>
					<th
						colSpan="2"
						className="fs-4 text-center table-primary">
						Election&nbsp;Details
					</th>
				</thead>
				<tbody>
					...
					<tr>
						...
						<td>
							{election.status ? 'Active' : 'Not Active'}
						</td>
					</tr>
					<tr>
						<td>Result Status</td>
					...
					<tr className="text-center ">
						<td
							colSpan="2"
							className="text-bg-secondary fw-bold fs-4">
							Candidates
						</td>
					</tr>
					{election.candidates.length >= 1 ? (
						...
						<tr>
							<td colSpan="2">
								No Candidates present for this Election
							</td>
						</tr>
					)}
					...
					<tr className="text-center ">
						<td
							colSpan="2"
							className="text-bg-warning fw-bold fs-4">
							Voters
						</td>
					</tr>
					{election.voters.length >= 1 ? (
						<>
							{election.voters.map((v, i) => (
								<tr key={i}>
									<td width="10%">{i + 1}</td>
									<td>{v}</td>
								</tr>
						...
						<tr>
							<td colSpan="2">
								No Voters had voted in this election
							</td>
						</tr>
					)}
				</tbody>
